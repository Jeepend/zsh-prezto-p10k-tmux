# Generated by Powerlevel10k configuration wizard on 2022-09-20 at 17:41 CST.
...
#	010 070 115
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX="%F{${COLOR_ARRAY[$(( $THEME_COLOR * 3 + 2 ))]}}>%F{$DEFAULT_FOREGROUND}>"
  ...
  typeset -g POWERLEVEL9K_PUBLIC_IP_BACKGROUND=96
  # Custom icon.
